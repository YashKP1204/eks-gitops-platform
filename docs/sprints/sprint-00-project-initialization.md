...
feature/* is used for planned implementation work.

fix/* is used for resolving discovered problems.

experiment/* is used for controlled failure injection and
temporary experimentation.

All completed work should be reviewed and merged into main.
